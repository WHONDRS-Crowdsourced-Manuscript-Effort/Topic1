...
% fixed Satellite assignment
% data = readtable("FTICR_crosstable_rep.merged1_all_em.thres_2022-03-18.csv", opts);
data = readtable("FTICR_crosstable_rep.merged2_all_em.thres_2022-03-18.csv", opts);
...
for icat = 1:size(catclass,1)
    ...
    cat1 = ["In-between" "Satellite" "Core"];
    %  water
    x1 = categorical(data2.csflagemergent_water,cat1);
    figure1 = figure;
    subplot(7,1,1), swarmchart(x1,data2.DBE,'.'), title('DBE')
    subplot(7,1,2), swarmchart(x1,data2.DBE_O,'.'), title('DBE O')
    subplot(7,1,3), swarmchart(x1,data2.DBE_AI,'.'), title('DBE AI')
    subplot(7,1,4), swarmchart(x1,data2.AI,'.'), title('AI')
    subplot(7,1,5), swarmchart(x1,data2.AI_Mod,'.'), title('AI mod')
    subplot(7,1,6), swarmchart(x1,data2.GFE,'.'), title('GFE')
    subplot(7,1,7), swarmchart(x1,data2.NOSC,'.'), title('NOSC'), hold on
    annotation(figure1,'textbox', [0.13 0.94 0.16 0.02],'String',{strcat('Water, emergent:', string(catclass(icat)))},'FitBoxToText','on');
    %  sediment
    x1 = categorical(data2.csflagemergent_sed,cat1);
    figure1 = figure;
    subplot(7,1,1), swarmchart(x1,data2.DBE,'.'), title('DBE')
    subplot(7,1,2), swarmchart(x1,data2.DBE_O,'.'), title('DBE O')
    subplot(7,1,3), swarmchart(x1,data2.DBE_AI,'.'), title('DBE AI')
    ...
    subplot(7,1,6), swarmchart(x1,data2.GFE,'.'), title('GFE')
    subplot(7,1,7), swarmchart(x1,data2.NOSC,'.'), title('NOSC'), hold on
    annotation(figure1,'textbox', [0.13 0.94 0.16 0.02],'String',{strcat('Sediment, emergent:', string(catclass(icat)))},'FitBoxToText','on');

    % pca
    cat1 = ["Satellite" "Core"];
    %  water
    x1 = categorical(data2.csflagpca_water,cat1);
    figure1 = figure;
    subplot(7,1,1), swarmchart(x1,data2.DBE,'.'), title('DBE')
    subplot(7,1,2), swarmchart(x1,data2.DBE_O,'.'), title('DBE O')
    subplot(7,1,3), swarmchart(x1,data2.DBE_AI,'.'), title('DBE AI')
    ...
    subplot(7,1,6), swarmchart(x1,data2.GFE,'.'), title('GFE')
    subplot(7,1,7), swarmchart(x1,data2.NOSC,'.'), title('NOSC'), hold on
    annotation(figure1,'textbox', [0.13 0.94 0.16 0.02],'String',{strcat('Water, PCA:', string(catclass(icat)))},'FitBoxToText','on');
    %  sediment
    x1 = categorical(data2.csflagpca_sed,cat1);
    figure1 = figure;
    subplot(7,1,1), swarmchart(x1,data2.DBE,'.'), title('DBE')
    subplot(7,1,2), swarmchart(x1,data2.DBE_O,'.'), title('DBE O')
    subplot(7,1,3), swarmchart(x1,data2.DBE_AI,'.'), title('DBE AI')
    ...
    subplot(7,1,6), swarmchart(x1,data2.GFE,'.'), title('GFE')
    subplot(7,1,7), swarmchart(x1,data2.NOSC,'.'), title('NOSC'), hold on
    annotation(figure1,'textbox', [0.13 0.94 0.16 0.02],'String',{strcat('Sediment, PCA:', string(catclass(icat)))},'FitBoxToText','on');

    % randomforest
    cat1 = ["Satellite" "Core"];
    %  water
    x1 = categorical(data2.csflagrf_water,cat1);
    figure1 = figure;
    subplot(7,1,1), swarmchart(x1,data2.DBE,'.'), title('DBE')
    subplot(7,1,2), swarmchart(x1,data2.DBE_O,'.'), title('DBE O')
    subplot(7,1,3), swarmchart(x1,data2.DBE_AI,'.'), title('DBE AI')
    ...
    subplot(7,1,6), swarmchart(x1,data2.GFE,'.'), title('GFE')
    subplot(7,1,7), swarmchart(x1,data2.NOSC,'.'), title('NOSC'), hold on
    annotation(figure1,'textbox', [0.13 0.94 0.16 0.02],'String',{strcat('Water, Random Forest:', string(catclass(icat)))},'FitBoxToText','on');
    %  sediment
    x1 = categorical(data2.csflagrf_sed,cat1);
    figure1 = figure;
    subplot(7,1,1), swarmchart(x1,data2.DBE,'.'), title('DBE')
    subplot(7,1,2), swarmchart(x1,data2.DBE_O,'.'), title('DBE O')
    subplot(7,1,3), swarmchart(x1,data2.DBE_AI,'.'), title('DBE AI')
    ...
    subplot(7,1,6), swarmchart(x1,data2.GFE,'.'), title('GFE')
    subplot(7,1,7), swarmchart(x1,data2.NOSC,'.'), title('NOSC'), hold on
    annotation(figure1,'textbox', [0.13 0.94 0.16 0.02],'String',{strcat('Sediment, Random Forest:', string(catclass(icat)))},'FitBoxToText','on');
