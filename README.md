...
Following documents/folders are being updated on a monthly basis:

- outline_topic1.docx
- ./monthly_slides

Please follow the following guidelines to populate this repository:

### Analysis folders

Each analysis included in the final manuscript should have its own folder following the naming strategy of:

>"(number in sequence of analysis)_descriptive.word"<br>
E.g. "1_data.cleaning", "2_mulvar.comparison"
  
For each analysis folder include:
...
Each figure included in the final manuscript should have its own folder following the naming strategy of:

>"fig(number of figure)_descriptive.word"<br>
E.g. "fig1_map", "fig2_threshold.concept"
  
For each figure folder include:
