The script generates swarm plots for a number of properties derived from the molecular formulae, such as double bonds, aromaticity, nominal oxidation state of carbon etc. 
